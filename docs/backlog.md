...
- Counted from the rows on 2026-09-16, after V3-S.6, V3-S.7 and S1-14.1 closed, not adjusted: each **OPEN**, **FIXED** and **GONE** row from "Stage 1" to the end of "Stage 2", and the lines of the two summary lists below.
