...
- AC-B2.2 **OPEN** — README.md:205-209 and :220-221 contradict each other about whether `icon.png` exists, in the section this branch rewrote — README.md:205-209, :220-221 — branch-review-2 Important 1
- AC-B2.3 **OPEN** — README.md's "What it does" (17-34) still describes the pre-recipes build and contradicts the recipe-terms paragraph six lines above it; the three-minute poll interval it cites was replaced by the recipe's own `EffectiveEverySeconds`, and `pollSeconds` no longer exists in Settings — README.md:17-34 — branch-review-2 Important 2
- AC-B2.4 **OPEN** — the README Troubleshooting table (169-178) lists state-line strings the app doesn't produce, including one this branch wrote ("Idle — nothing to watch"); four of the listed rows are states `BoardText.Healthy` treats as fine and `StateLine` never prints — README.md:169-178 — branch-review-2 Important 3
