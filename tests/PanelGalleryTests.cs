...
public class PanelGalleryTests
{
    ...
    public void EveryCardInOrderTitledInTheRecipesWords()
    {
        ...
        Assert.Equal(
            new[] { "Clan standing", "Battle race", "My accounts", "Promotion check", "Account card", "Past battles", "Records", "Clan pace", "Top of the battle", "Profile stat", "Accounts table", "Live leaderboard" },
    ...
    public void WithNothingInstalledEveryCardIsOffAndSaysWhy()
    {
        ...
        Assert.Equal(
            new[] { "Standing", "Race", "My accounts", "Promotion check", "Account card", "Past periods", "Records", "Pace", "Top of the list", "Profile stat", "Accounts table", "Live leaderboard" },
            cards.Select(c => c.Title).ToArray());
